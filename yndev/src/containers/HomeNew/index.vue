<template>
  <div @load="contentLoad">
    ...
    <!--图片弹出层-->
    <div v-if="popupVisible" @click.stop="hideImgCover" class="showImg" style="width:100%;height:100%">
      <!--遮罩-->
      <div class="zxCover" style="width:100%;height:100%"></div>
      <img style="width:100%;" class="centerImg" :src="activePic"/>
    </div>
    <AnimateRefresh @dataRefresh="dataRefresh" ref="animatexl" style="position: absolute;z-index: 100;margin-left: 50%;">
				</AnimateRefresh>
    <div id="cjyHomeOuter"
      style=" height:100vh; overflow: auto; webkit-overflow-scrolling:touch;position: absolute;top:0;width: 100%;padding-top: 3rem"
      ref="outerScroll">
      <!--<PullDownScroll>-->
      <div>
        <!-- 搜索框部分 -->
                        ...
                        <li v-for="item in discountData" @click='jumpEvent(item)'>
                            ...
                            <div class="suggest">
                                ...
                                <p class="original_price">原价
                                    <del>¥{{parseFloat(item.normalprice).toFixed(2)}}</del>
                                </p>
        ...
        <!-- 分类推荐 -->
        <ClassifyRecommend></ClassifyRecommend>
        <!--<div class="classify_con" v-if="finalList" v-for="item in finalList">
...
<script>
  ...
  import AnimateRefresh from "../../components/AnimateRefresh"
