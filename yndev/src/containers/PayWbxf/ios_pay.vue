        ...
        <div>
            ...
            <div class="centent payment_con">
                ...
                <div  class="settle_accounts lijixiadan">
                    <div id="paywb" style="background:#970000 !important" class="aui-btn aui-btn-danger aui-btn-block aui-btn-sm" @click.stop="pay" ref="paywb">确定</div>
                </div>
                <!--确定 end-->
            </div>
        </div>
...
import { notifyPayPayStar } from '../Pay/http'
export default {
    props: {
        ...
        init() {
                    ...
                    SEPayPlugin(pay,
                        function(){
                            ...
                            // setTimeout(() => {
                                ...
                                that.$router.replace({"name": "paysuccessfully", params: {orderType: 31}});
            ...
            var SEPayPlugin =  function  (params,sucFunc,failFunc,opts, className) {
                ...
                try{
                    ...
                    Toast({
                        message: '如您在app中进行支付，程序调起支付app失败，请点击按钮手动尝试下！',
                        iconClass: "aui-iconfont aui-icon-close",
                        duration: 1600
                    });
                }
            }
            this.$refs.paywb.onclick = async function() {
