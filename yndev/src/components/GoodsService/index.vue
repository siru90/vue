            ...
            <div class="spec_top" v-if="pageType==='detail'">
                ...
                <div class="spec-price">
                    ...
                    <p v-if="parseInt(gwGoodsItem.goodsType) === 0">
                        ...
                        <!-- <span v-if="!gwGoodsItem.stockCount" >已售罄</span> -->
                    </p>
                </div>
                <!-- 关闭按钮 -->
        ...
        confirm() {
            ...
            if (this.checkGoodsId()) {
                ...
                if (this.pageType === "detail") {
                    //如果没有库存，提示用户
                    if (parseInt(this.gwGoodsItem.stockCount) <= 0 && (parseInt(this.gwGoodsItem.goodsType) === api.normalGoodsType || parseInt(this.gwGoodsItem.goodsType) === 3)) {
                    ...
                    if (!exist) {
                        ...
                        if (this.addGroupCarFn) {
                            ...
                            this.addGroupCarFn(this.gwGoodsItem,that.detailsGoodsNum)
                        } else {
                            updateCart(params, callback);
                        }
