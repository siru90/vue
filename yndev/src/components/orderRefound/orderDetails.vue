...
<template>
	<div class="vue_app" style="position: absolute;width: 100%">
		...
		<div class="centent" v-if="show">
			...
			<div class="order_logistics_box" v-for="(val, index) in orderInfo.data" v-show="val.serviceType == 3" :key="index" >
				...
				<transition-group  name="fade">	
					<div class="delivery_box" v-if="val.approvalOrder" :key="index" :class="{hiddren:!(num.includes(index))}">
						<ul class="delivery_list" >
							<li :class="{start:i==0}" v-for="(item,i) in val.approvalOrder" :key="i">
								<i class="line_icon"></i>
