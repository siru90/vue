...
export default {
    ...
    created() {
        ...
        if (this.$route.name === "goodsDetail") {
            console.log(this.serviceItemData.list)
            this.changeActiveIndex(0,this.serviceItemData.category,this.serviceItemData.list[0].id,this.serviceItemData.list[0])
        }
