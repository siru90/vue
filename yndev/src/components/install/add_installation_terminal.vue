<template>
    <div id="addinstalter" style="width: 100%">
            ...
            <ul class="aui-list aui-form-list top_ul">
                ...
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input type="radio" class="aui-checkbox" name="serviceMode" value="0" v-model="serviceMode" id="goShop"><label for="goShop">进站</label>
...
export default {
    ...
    mounted() {
        setTimeout(() => {
            const yearLine = document.querySelector("#addinstalter .mint-datetime .picker-slot.picker-slot-center")
            if (yearLine) {
