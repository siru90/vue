...
<div style="position:absolute;width:100%;">
	...
	<router-link :to="{path:'/main/addInstall', query:{serviceId:serviceId,serviceNo:serviceParam,addressDetails:addressDetails,othsid:carId,memo:serviceDescrible,orderDate:subscribeDate,sub:sub,order:order,username:username,phone:phone,address:address,serverType:serverType,type:type,maintenancetype:maintenancetype }}">
		<div class="go-back">
			<i></i>
			<i></i>
			<i></i>
	...
	<ul class="aui-list aui-media-list address_list top_div" v-for="(item, index) in data" :key="index">
        <router-link :to="{path:'/main/addInstall', query:{serviceId: item.serviceid,serviceNo:serviceParam,addressDetails:addressDetails,othsid:carId,memo:serviceDescrible,orderDate:subscribeDate,sub:sub,sub_1:0,order:order,username:username,phone:phone,address:address,serverType:serverType,type:type,maintenancetype:maintenancetype}}">	
