<template>
  <div class="order_list_div" style="position: absolute;width: 100% ;top:3rem;">
    ...
    <header class="aui-bar aui-bar-nav aui-bar-light">
      <div style="width: 100%;height:2.75rem;position:relative">
          ...
          <ul class="aui-list aui-media-list commodity_list subtotal_list" v-for="(item, index) in data" :key="index">
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                  <div class="aui-list-item-text item-margin">
                    <div class="aui-list-item-title">总单编号：{{item.parentOrderNo}}</div>
                    <div class="aui-list-item-right aui-font-size-14 btn" ref="mycopy" :data-clipboard-text="item.parentOrderNo"><div @click="getRef" class="aui-btn order-copy-btn aui-btn-outlined">复制</div></div>
                  </div>
                  <div class="aui-list-item-text">
                    <div class="aui-list-item-title">子单编号：{{item.orderNo}}</div>
