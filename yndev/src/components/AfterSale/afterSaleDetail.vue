			...
			<div class="order_logistics_box">
				<div class="delivery_box" v-if="returnStatus.length != 0">
					<ul class="delivery_list" >
						<li :class="{start:index==0}" v-for="(item,index) in returnStatus" :key="index">
							<i class="line_icon"></i>
						...
						<div class="aui-list-item-inner">
							...
							<div class="aui-card-list-content-padded aui-border-b aui-border-t aui-padded-0">
								...
								<div class="aui-row aui-row-padded" style="display:flex;flex-flow:row wrap;">
									<!--class="aui-col-xs-4"-->
									<div class="aui-col-xs-4 imgItem"  @click.stop="getImgCover(imgUrl)" :key="index"  v-for="(imgUrl,index) in getImg" style="padding-bottom: 33.33333333%;height: 0;overflow: hidden;">
