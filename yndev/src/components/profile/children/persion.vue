          ...
          <vue-clip :options="options" :on-complete="complete" :on-max-files="maxFilesReached"
            ...
            <template slot="clip-uploader-body" scope="props ">
              <div class="aui-list-item-right " style="float: right; ">
                ...
                <div :key="index" class="aui-list-item-media js_showBox backgroundShowPic" v-if=" index+1 == props.files.length"
      ...
      changeUserInfo(val) {
        switch (val) {
          ...
          case "birthday":
            ...
            break;
          case "email":
            // 某些账号没有email时返回的是空字符串，这会导致下面这个傻逼组件发生一个错误
            if (this.email === "") {
              this.email = null
            }
