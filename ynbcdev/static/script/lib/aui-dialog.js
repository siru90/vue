    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                params.inputType = params.inputType ? params.inputType: 'text';
                var msgHtml = '<div class="aui-dialog-body"><input id="auiDialogInput" type="'+params.inputType+'" placeholder="'+params.text+'"></div>';
            }else{
                        ...
                        if(callback){
                            if(params.input){
                                callback({
                                    ...
                                    text: document.querySelector("#auiDialogInput").value
                                });
                            }else{
                                callback({
                                    buttonIndex: parseInt(this.getAttribute("button-index"))+1
