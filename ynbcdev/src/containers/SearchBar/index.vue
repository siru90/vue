  ...
  <div>
    <div class="aui-searchbar searchbar" id="search">
      <div class="aui-searchbar-input aui-border-radius">
        ...
        <div style="" class="aui-searchbar-clear-btn" style="display:block" v-show="searchWord != '' "
             @click="searchWord = ''">
    ...
    <transition name="fade">
      <div v-show="iii">
        ...
        <div class="aui-content-padded">
          ...
          <div class="aui-btn" v-for="item in historySearch" v-if="historySearch" @click=" changeSearchWord(item) ">{{item}}</div>
        </div>
        <!--搜索历史 end-->
        <!--热门搜索-->
        <div class="aui-content-padded">
          <p>热门搜索</p>
          <div class="aui-btn" v-for="item in hotSearch" @click=" changeSearchWord(item) ">{{item}}</div>
          &nbsp
