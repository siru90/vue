  ...
  <div class="order_list_div" style="width: 100%;">
    ...
    <header class="aui-bar aui-bar-nav aui-bar-light">
      <div style="height:2.75rem;position:relative">
        ...
        <div class="aui-title">
          {{param == 0 ? "终端安装单" : (param == 1 ? "配件安装单" : (param == 2 ? "维修预约" : (param == 3 ? "保养预约" : (param == 4 ? "终端维修":(param == 5 ? "终端拆除" : (param==6?"终端售后":''))))))}}
        </div>
          ...
          <ul class="aui-list aui-media-list service_list" v-if="data && item[mainIntalcode] == param%2"
            ...
            <li class="aui-list-item">
              ...
              <div class="aui-list-item-inner">
                <div class="aui-list-item-text">
                  ...
                  <div class="aui-list-item-title">工单编号：{{param == 0 || param == 1 ? item.installno : (param == 2 || param == 3 ? item.maintenanceno : (param == 4  ? item.maintenanceno : ( param == 5 ? item.removeno : (param==6?item.aftersaleserviceno:''))))}}</div>
            ...
            <li class="edit_address" style="border-top: 0 solid transparent;">
              ...
              <div  class="aui-btn aui-btn-danger aui-btn-outlined"
               ...
               <div  class="aui-btn aui-btn-danger aui-btn-outlined"
                     v-show="item.usestatus == '0.2' || item.usestatus =='1'|| item.usestatus =='0'|| item.usestatus =='8'" @click="dancel(item.installno)" v-if="param == 0 || param == 1">取消预约
                </div>
    ...
    methods: {
      ...
      filter(data){
        ...
        for (let i of data) {
          ...
          //     this.arrel.push(i);
          // }
          if(this.param==2||this.param==3||this.param==1){
            if(i.usestatus == 0 && i.orderdate == null) {
              i.usestatus = 0.1;
              this.arr.push(i);
