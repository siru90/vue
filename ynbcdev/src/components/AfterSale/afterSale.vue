...
<template>
	...
	<div class="vue_app" style="position: absolute;width: 100%">
		...
		<div class="settle_accounts fixed_div aui-card-list-content-padded aui-border-b aui-border-t">
			<div style="background:#970000 !important" class="aui-btn aui-btn-block aui-btn-danger" tapmode  @click.stop="upMethod">提交申请</div>
		</div>
...
//				console.log(goodsNum, afterSaleCount, parseInt(this.actureBackNum));
