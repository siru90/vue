<template>
    <div id="wbtxdetail">
        ...
        <div class="wbtxdetail-content">
            <div class="wb-detail">
                <div class="wbtx-item-mid">
                    <div class="wbtx-img">
                        <img :src="wbDetail.remindtype == '1' ? 'static/image/weixiu.png': 'static/image/baoyang.png'" alt="" srcset="">
        ...
        <div class="wbtxdetail-bottom">
            <div @click="gotoHome" class="bottom-left-item">
                购买配件
            </div>
            <div @click="gotoYY" class="bottom-right-item">
                预约维保
            </div>
        </div>
    </div>    
