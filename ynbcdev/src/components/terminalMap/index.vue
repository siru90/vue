<template>
    <div style="width:100%;height:100%;padding-top:2.75rem;background-color:white;">
        <header style="display:block;" class="aui-bar aui-bar-nav aui-bar-light">
            <router-link :to="iswbxf ? {path:'/wbxfWorkOrder',query:{serviceNo:serviceParam,sub:this.sub}}:{path:'/main/addInstallTerminal',query:{serviceNo:serviceParam,sub:this.sub}}">
                <div class="go-back">
                <i></i>
                <i></i>
                <i></i>
...
export default {
    ...
    methods:{
        ...
        sureAddress(){
            ...
            this.$router.push(this.iswbxf ? {path:'/wbxfWorkOrder', query: {serviceNo: this.serviceParam,sub:this.sub}}:{path: '/main/addInstallTerminal', query: {serviceNo: this.serviceParam,sub:this.sub}});
