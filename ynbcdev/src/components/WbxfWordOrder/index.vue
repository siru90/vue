                ...
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input type="text" v-model="carNo" readonly style="height:1.4rem;padding-left:0.2rem;color:#333;background-color:#f1f1f1;">
                        </div>
                    </div>
                </li>
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input type="text" v-model="engineNo" readonly style="height:1.4rem;padding-left:0.2rem;color:#333;background-color:#f1f1f1;">
                        </div>
                    </div>
                </li>
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input type="text" v-model="teleptleNo" readonly style="height:1.4rem;padding-left:0.2rem;color:#333;background-color:#f1f1f1;">
                        </div>
                    </div>
                </li>
            </ul>
            <ul class="aui-list aui-form-list top_ul">
                ...
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input v-model="faultcode" type="text" style="height:1.4rem;padding-left:0.2rem;color:#333;">
                        </div>
                    </div>
                </li>
                <!-- <li class="aui-list-item">
                ...
                <li class="aui-list-item">
                    <div style="width:100%;display:flex;padding-top:0.5rem;">
                        ...
                        <div>
                            <textarea v-model="faultdesc" style="margin-top:0;" placeholder="请输入故障描述">
                            </textarea>
                        </div>
                    </div>
                </li>
            ...
            <ul class="aui-list aui-form-list top_ul">
                ...
                <li class="aui-list-item">
                    <div class="aui-list-item-inner">
                        ...
                        <div class="aui-list-item-input">
                            <input type="radio" class="aui-checkbox" name="serviceMode" value="1" v-model="serviceMode" id="goShop"><label for="goShop">到店</label>
...
export default {
    ...
    beforeMount() {
        ...
        if (defautlData) {
            ...
            this.faultcode = defautlData.faultcode
            this.faultdesc = defautlData.faultdesc
        }
    },
    components: {
        "mt-picker": Picker,
    ...
    methods:{
        ...
        async submitData(){
            ...
            let data = {
                ...
                "orderdate":this.subscribeDate.format('yyyy-MM-dd'), //预约时间
